/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6623b03de53f1ac230103cd29052db1c)
...
declare namespace Cloudflare {
	...
	interface Env {
		CONTACT_MAIL_FROM: "Race Digital <onboarding@resend.dev>";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTACT_MAIL_FROM" | "RESEND_API_KEY">> {}
}
